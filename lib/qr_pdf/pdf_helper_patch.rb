module QrPdf
  module PdfHelperPatch
    def self.included(base)
      base.extend(ClassMethods)

      base.send(:include, InstanceMethods)
      base.class_eval do
        alias_method_chain :issue_to_pdf, :modif
      end
    end
  end
  ...
  module InstanceMethods
    def issue_to_pdf_with_modif(issue, assoc={})
      ...
      pdf.SetFontStyle('B', 2)
      pdf.RDMwriteQRCodeCell(issue_url(issue))
      pdf.ln
      pdf.SetFontStyle('B',9)
